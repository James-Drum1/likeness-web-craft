...
const Pricing = () => {
  const features = ["Business profile listing", "Logo & business details", "Photo gallery (10 photos)", "Contact details display", "Customer reviews integration", "Google Maps location", "Priority email support", "Featured listing", "Premium placement in search", "Verified business badge", "Lead notification alerts", "Custom color theme", "Video uploads"];
  return <div className="min-h-screen">
      <Header />
      
      <div className="py-20 px-6" style={{
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="border border-gray-200 rounded-lg p-8 bg-white">
              ...
              <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 text-lg font-semibold" onClick={() => window.location.href = '/tradesperson-signup?plan=monthly'}>
                Choose Monthly
              </Button>
            </div>
            ...
            <div className="border-2 border-blue-500 rounded-lg p-8 bg-white relative">
              ...
              <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 text-lg font-semibold" onClick={() => window.location.href = '/tradesperson-signup?plan=annual'}>
                Choose Annual
              </Button>
            </div>
          </div>
