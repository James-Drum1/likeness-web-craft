-- Temporarily drop the circular foreign key constraint
ALTER TABLE public.memorials DROP CONSTRAINT IF EXISTS memorials_id_fkey;

-- Create sample QR code first (without memorial_id reference yet)
...
ADD CONSTRAINT memorials_id_fkey 
FOREIGN KEY (id) REFERENCES public.qr_codes(id);
