-- Fix the handle_new_user function to use fully qualified enum type names
...
BEGIN
  ...
  IF COALESCE((NEW.raw_user_meta_data ->> 'user_type')::public.user_type, 'customer'::public.user_type) = 'tradesperson'::public.user_type THEN
