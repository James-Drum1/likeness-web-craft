-- Update handle_new_user to also insert initial services from signup metadata
  ...
  IF v_is_worker THEN
    ...
    IF (NEW.raw_user_meta_data ? 'services') THEN
      ...
      SELECT
        ...
        COALESCE((elem.value->>'category')::public.service_category, 'other'::public.service_category),
